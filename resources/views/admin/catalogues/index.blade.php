                                ...
                                <tbody class="list form-check-all">
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="phone">
                                                {{-- {{ $item->parent?->name ?? 'Trống' }} --}}
                                                <select data-id="{{ $item->id }}" name="catalogue_id"
                                                    class="select_catalogue form-select form-select-sm"
                                                    aria-label=".form-select-lg example">
                                                    <option value="" @selected($item->parent == null)>Trống</option>
                                                    @foreach ($catalogues as $catalogue)
                                                        @continue($catalogue->id == $item->id)
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            removeNotificationModal.addEventListener('show.bs.modal', event => {
                ...
                document.getElementById('delete-notification').addEventListener('click', () => {
                    ...
                    let url = `{{ route('admin.catalogues.destroy', '') }}/${id}`;
            ...
            document.getElementById('submit_form_create').addEventListener('click', () => {
                ...
                let url = '{{ route('admin.catalogues.store') }}'
