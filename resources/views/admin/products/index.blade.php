                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td data-ordering="false">
                                        <img width="100px"
                                            src="{{ $item->image && Storage::exists($item->image) ? Storage::url($item->image) : null }}"
                                            alt="">
                                    ...
                                    <td data-ordering="false">
                                        <div class="form-check form-switch form-switch-success d-inline">
                                            <input class="is_active form-check-input" data-id="{{ $item->id }}"
                                                type="checkbox" role="switch" value="1" @checked($item->is_active)>
                                        </div>
                                    </td>
