...
@section('content')
    ...
    <form id="form_create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="live-preview">
                            <div class="row gy-5">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-floating">
                                        <input name="sku" type="text" value="{{ strtoupper(Str::random(8)) }}"
                                            class="form-control" id="firstnamefloatingInput"
                                            placeholder="Enter your firstname">
                                        <label for="firstnamefloatingInput">sku</label>
                                    </div>
                                    <div class="form-floating mt-3">
                                        <input name="price_regular" type="number" min="0" class="form-control"
                                            id="firstnamefloatingInput" placeholder="Enter your firstname">
                                        <label for="firstnamefloatingInput">price_regular</label>
                                    </div>
                                    <div class="form-floating mt-3">
                                        <input name="price_sale" type="number" min="0" class="form-control"
                                            id="firstnamefloatingInput" placeholder="Enter your firstname">
                                        ...
                                        @foreach ($is as $key => $color)
                                            <div class="mt-3 col-md-3">
                                                <div class="form-check form-switch form-switch-{{ $color }}">
                                                    <input checked name="{{ $key }}" value="1"
        ...
        <button id="btn_submit" type="submit" class="btn btn-success">Thêm</button>
        <a href="{{ route('admin.products.index') }}" class="btn btn-primary">Quay lại</a>

    </form>

    {{-- <div data-name="product_variants[1-1][image]" class="card-body image_variants" style="width: 200px;">
...
@section('script_libs')
                    ...
                    colors.forEach(function(color) {
                        ...
                        var bien_the_html =
                            `<tr>
                                ...
                                <td style="vertical-align: middle;"><input type="number" value="1" name="product_variants[${size.id}-${color.id}][quantity]" class="form-control"></td>
    ...
    <script>
        ...
        //end_FilePond
        document.querySelector("#form_create").addEventListener("submit", function(e) {
            e.preventDefault();
            e.stopPropagation();
