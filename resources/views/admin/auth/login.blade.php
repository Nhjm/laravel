...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('theme/admins/assets/images/favicon.ico') }}">
...
<body>
    ...
    <!-- particles js -->
    <script src="{{ asset('theme/admins/velzon/assets/libs/particles.js/particles.js') }}"></script>
    <!-- particles app js -->
    <script src="{{ asset('theme/admins/velzon/assets/js/pages/particles.app.js') }}"></script>
    <!-- password-addon init -->
    <script src="{{ asset('theme/admins/velzon/assets/js/pages/password-addon.init.js') }}"></script>
</body>
