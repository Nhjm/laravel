                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="center" style="padding:40px 0 35px 0">
                                                        {{-- <a
                                                            href="https://www.chewy.com?utm_medium=email&amp;utm_source=transactional&amp;utm_campaign=ShippingConfirmation"
                                                            target="_blank"
                                                ...
                                                <tr>
                                                    <td align="center"
                                                        ...
                                                        <p style="text-align: center;">
                                                            <img src="{{ env('URL') }}/images/ship.gif"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="117" align="right"
                                                            ...
                                                            <a href="https://www.chewy.com/dp/116520?utm_medium=email&amp;utm_source=transactional&amp;utm_campaign=ShippingConfirmation"
                                                                ...
                                                                <img width="100px"
                                                                    src="{{ env('URL') . '/storage/' . $item['img_thumbnail'] }}"
                                                                    border="0">
                                                            </a>
                                                        </td>
                                                        <td width="270"
